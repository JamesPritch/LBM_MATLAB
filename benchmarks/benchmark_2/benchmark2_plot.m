...
% Error in C
Error = norm(C_BGK_plot_antiBB(2,:) - C_plot_exact(2,:), 'fro')/...
    norm(C_plot_exact(2,:), 'fro');
...
xlim([0 1])
ylim([0 1])
leg = legend('${t^* = 0.0547}$ (Analytical)', '${t^* = 0.0547}$ (Numerical)', ...
    '${t^* = 0.1095}$ (Analytical)', '${t^* = 0.1095}$ (Numerical)', ...
